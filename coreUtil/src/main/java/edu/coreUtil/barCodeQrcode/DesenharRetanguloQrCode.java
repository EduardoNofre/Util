...
public class DesenharRetanguloQrCode extends JPanel {
	...
	protected DesenharRetanguloQrCode() {
	}

	protected DesenharRetanguloQrCode(BufferedImage image) {

		this.image = image;

		size.setSize(image.getWidth(), image.getHeight());

		MouseAdapter mouseAdapter = new DesenharRetanguloQrCode.MyMouseAdapter();
	...
	private class MyMouseAdapter extends MouseAdapter {
		...
		public void mouseReleased(MouseEvent e) {
			...
			try {
				...
				barCodeQrCode.lerQRcode(image, rect);
		...
		public void mouseDragged(MouseEvent e) {
			...
			DesenharRetanguloQrCode.this.repaint();
