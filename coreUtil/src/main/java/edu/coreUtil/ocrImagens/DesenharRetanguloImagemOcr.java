...
public class DesenharRetanguloImagemOcr extends JPanel {
	...
	protected DesenharRetanguloImagemOcr(BufferedImage image) {

		this.image = image;

		size.setSize(image.getWidth(), image.getHeight());

		MouseAdapter mouseAdapter = new DesenharRetanguloImagemOcr.MyMouseAdapter();
	...
	private class MyMouseAdapter extends MouseAdapter {
		...
		public void mouseDragged(MouseEvent e) {
			...
			DesenharRetanguloImagemOcr.this.repaint();
